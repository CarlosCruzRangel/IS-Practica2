$(document).ready(function () {
  ...
  $('.color-box').click(function () {
    ...
    $('#title-field').css('color', color);
    // $('#body-field').css('color', color);
  });

  $('.color-boxbody').click(function () {
    var colorbody = $(this).css('background-color');
    // $('notepad').css('background-color', color);
    // $('#title-field').css('color', color);
    $('#body-field').css('color', colorbody);
  });
  ...
  $('#btn-save').click(function () {
    ...
    if (title === '' && body === '') {
      alert('Agregue un título o cuerpo a su nota.');
      return;
    }
    ...
    if (activeNote) {
      ...
      $('#' + activeNote)[0].children[1].innerHTML = created.toLocaleString('en-ES');
      ...
      $('#listed').append(
        '<div id="note' +
          ...
          title +
          '</div> <div class="list-date">' +
          created.toLocaleString('en-ES') +
    ...
    $('#title-field').val('');
    $('#body-field').val('');
    $('notepad').css('background-color', '#41a0e8');
